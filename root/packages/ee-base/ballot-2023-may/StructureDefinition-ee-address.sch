...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Address">
      <sch:assert test="count(f:extension[@url = 'https://fhir.ee/StructureDefinition/ee-ads']) &lt;= 1">extension with URL = 'https://fhir.ee/StructureDefinition/ee-ads': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://fhir.ee/StructureDefinition/ee-ehak']) &lt;= 1">extension with URL = 'https://fhir.ee/StructureDefinition/ee-ehak': maximum cardinality of 'extension' is 1</sch:assert>
