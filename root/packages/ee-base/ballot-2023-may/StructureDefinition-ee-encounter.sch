...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Encounter">
      <sch:assert test="count(f:extension[@url = 'https://fhir.ee/StructureDefinition/ee-mode-of-arrival']) &lt;= 1">extension with URL = 'https://fhir.ee/StructureDefinition/ee-mode-of-arrival': maximum cardinality of 'extension' is 1</sch:assert>
